...
<head>
    ...
    <title>Houses and Apartments</title>
</head>
...
<div class=head>
   ...
   <h1><span class="title">C</span>rystal <span class="title">L</span>ands & <span class="title">H</span>ouses</h1> 
    ...
    <ul>
        <li><a href="index(r_buyer).html">Home</a></li>
        <li><a  href="lands(r_buyer).php">Lands</a></li>
        <li><a class = "active1" href="#">Houses & Appartments</a></li>
        <li><a href="Design a house(r_buyer).php">Design a House</a></li>
...
<div class = "heading">
	<h2 class = "title">Houses and Apartments</h2>
</div>
...
<?php
	require 'config.php';
	$sql= "SELECT * FROM lands_houses_apartments WHERE prType in ('house', 'apartment')";
